...
import { SkinOutlined,AuditOutlined } from "@ant-design/icons";
...
const ProductsId = () => {
	...
	const [modalFindVisible, setModalFindVisible] = useState(false);
	...
	const handleShowModalFind = () => {
		setModalFindVisible(true);
	};

	const handleCancelModalFind = () => {
		setModalFindVisible(false);
	};
	const elements = {
		name: "lobo1",
		value: 5524,
			...
			<Row>
				...
				>
					...
					<Button
						...
						type="primary"
						icon={<SkinOutlined style={{ fontWeight: "bold" }} />}
						onClick={handleShowModalFind}
					>
						Encuentra tu talla
					</Button>
					<FindYourSize
						visible={modalFindVisible}
						onCancel={handleCancelModalFind}
						element={elements}
					/>
					<Row
						style={{
					...
					<Collapse accordion>
						...
						<Panel header="Composición y cuidados" key="2">
							<div class="b2cmattelsa-store-theme-0-x-specification_layout">
								<ul classname="b2cmattelsa-store-theme-0-x-specification_item_pdp">
									<li>
										<img
											src="/arquivos/lavadora-icon.png"
											alt="icon-wash"
										/>
									</li>
									<li>
										<p>
											Usa lavadora en ciclo delicado y
											agua fria
										</p>
									</li>
								</ul>
								<ul classname="b2cmattelsa-store-theme-0-x-specification_item_pdp">
									<li>
										<img
											src="/arquivos/secadora-icon.png"
											alt="icon-wash"
										/>
									</li>
									<li>
								...
								<ul classname="b2cmattelsa-store-theme-0-x-specification_item_pdp">
									<li>
										<img
											src="/arquivos/blamqueador-icon.png"
											alt="icon-wash"
										/>
									</li>
									<li>
								...
								<ul classname="b2cmattelsa-store-theme-0-x-specification_item_pdp">
									<li>
										<img
											src="/arquivos/si-pancha-icon.png"
											alt="icon-wash"
										/>
									</li>
									<li>
										<p>
											Plancha a temperatura baja No
											planches el estampado{" "}
										</p>
									</li>
								</ul>
								...
								<ul classname="b2cmattelsa-store-theme-0-x-specification_item_pdp">
									<li>
										<img
											src="/arquivos/retorcer-icon.png"
											alt="icon-wash"
										/>
									</li>
									<li>
						...
						<Panel header="Cambios y garantías" key="4">
							<p>
								Tu envío es <span>gratis</span> si tu lugar de
								envío es{" "}
								<span>
									Medellín y área metropolitana, Bogotá, Cali,
									Barranquilla o Bucaramanga
