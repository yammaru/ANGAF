...
const PanelPrincipal = ({ how, whoIsSet, howSet }) => {
	...
	return 1 == 2 ? (
		<>
			...
			>
				<Title level={5}>
					{how == "BG" ? (
						<LeftOutlined onClick={onclickGoBack} />
					) : null}{" "}
					Iniciar sesión
				</Title>
			...
			>
				<a className="footer-anga" onClick={onclickGoMail}>
				...
				<div class="svgContainer">
					<div>
						...
						>
							...
							<circle cx="100" cy="100" r="100" fill="#CC9F22" />
							<g class="body">
								<path
									class="bodyBGchanged"
									style={{ display: "none" }}
	...
	function initLoginForm() {
		...
		screenCenter = svgCoords.x + mySVG ? mySVG.offsetWidth : 0 / 2;
