...
import { creatProjectsClassification, fetchAllProjectsClassification } from '../../../../../redux/actions/Configuration/ProjectsClassificationsAction';
...
const RegisterFormComponent = () => {
	...
	const sendData = async () => {
		...
		try {
			dispatch(
				creatProjectsClassification(values, async (response) => {
	...
	return (
		<>
			...
			<Modal
				title="Nueva Clasificacion de proyecto"
				centered
